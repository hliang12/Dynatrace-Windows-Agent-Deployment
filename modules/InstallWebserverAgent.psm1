...
#>
	...
	#If fresh install, backup config file
	...
	"# Dynatrace Webserver agent auto-generated by Powershell script"
	$stream.WriteLine("# Dynatrace Webserver agent auto-generated by Powershell script")

	#Get parameters in corrupted hashmap (compatible with powershell v2)
	$option = [System.StringSplitOptions]::RemoveEmptyEntries
	$keys = $Config.keys -split " "
	$values = $Config.values -split " "
	
	#Printing config in file
	for($i=0 ; $i -lt $keys.length ; $i++)
	{
		$key = $keys[$i]
		$value = $values[$i]
		Write-Host "Injecting $key $value" -ForegroundColor green
